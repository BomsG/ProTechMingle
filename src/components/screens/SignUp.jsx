      ...
      <div className="lg:flex lg:items-center font-inter">
        <div className="hidden lg:block lg:bg-gray lg:h-full lg:w-1/2">
          <div className="w-9/12 mx-auto mt-20 mb-16">
            <h2 className="text-4xl font-medium mb-10">
              Introducing <span className="text-dash">-</span>
            </h2>
            ...
            <div className="flex items-center mb-6">
              <img src={Star} alt="star" className="mr-3" />
              <p className="text-lg font-medium text-black">
                Discover and apply to the most suitable job opportunities for
                you.
              </p>
            </div>
            <div className="flex items-center mb-6">
              <img src={Star} alt="star" className="mr-3" />
              <p className="text-lg font-medium text-black">
                Find events that align with your preferences.
              </p>
            </div>
          </div>
          <div>
        ...
        <div className="bg-white lg:w-1/2">
          <div className="max-w-md lg:w-9/12 m-auto py-6 lg:py-0">
            ...
            <h2 className="text-2xl md:text-4xl font-medium text-center mb-3">
              Create an account
            </h2>
            <h6 className="font-normal text-center text-black text-xl">
              Let’s get you started.
            </h6>
            <form
              className="mt-6 w-11/12 lg:max-w-md mx-auto lg:w-full"
              onSubmit={handleForm}
            >
              <label>
              ...
              <input
                type="submit"
                value="Get Started"
                className="text-center w-full bg-signupButton text-white text-xl font-semibold rounded-md py-4 px-6 cursor-pointer mb-6"
              />
            </form>
            <button className="max-w-md mx-auto w-11/12 lg:w-full border border-solid border-signupButton rounded-md p-4 mb-6 flex items-center justify-center">
              <img src={buttonIcon} alt="google icon" className="mr-2 w-9" />
              <span className="font-semibold text-xl text-signupButton">
                Sign up with Google
              </span>
            </button>
            <Link to="/Login">
              <h6 className="mb-9 lg:mb-0 font-normal text-base lg:text-xl text-center">
                Already have an account?{" "}
                <span className="font-medium text-signupButton">
                  <Link to="/">

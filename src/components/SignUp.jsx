      ...
      <div className='lg:flex lg:items-center font-inter'>
        ...
        <div className='bg-white lg:w-1/2'>
          <div className='max-w-md lg:w-9/12 m-auto py-6 lg:py-0'>
            ...
            <h6 className='mb-9 lg:mb-0 font-normal text-base lg:text-xl text-center'>Already have an account? <span className='font-medium text-signupButton'><a href='/login'>Log in</a></span></h6>
          </div>
        </div>
      </div>
    </>

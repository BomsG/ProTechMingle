...
function WriteComment() {
  return (
    <div className="grid grid-cols-[80px_1fr] gap-[15px] w-full py-[12px] ">
      <div>
        <img src={Image} className="h-[50px] w-[50px]" alt="" />
      </div>
      <div className="flex bg-[#F7F7F7] justify-between p-[10px] rounded-[5px]">
        <input type="text" className="bg-[#F7F7F7] placeholder:textp[#252525] focus:outline-none focus:border-none" placeholder="Write your Comment" />
